...
def _decode_hand_state(data: bytes) -> dict:
    c = _CDRCursor(data)
    hs, hn = _read_header(c)
    return {
        "header_sec": hs,
        "header_nanosec": hn,
        "left_valid": bool(c.read_u8()),
        "right_valid": bool(c.read_u8()),
        "left_sample_age_ms": c.read_u32(),
        "right_sample_age_ms": c.read_u32(),
        "position": c.read_seq_f64(),
        "velocity": c.read_seq_f64(),
        "current": c.read_seq_f64(),
        "state": c.read_seq_u8(),
    }
...
_HARDCODED: dict[str, Any] = {
    ...
    "leju::msgs::HandState":    _decode_hand_state,
