...
# Roban2-0
ROBAN2_0_DUAL_SOURCE_CONFIG_FILE="$PROJECT_DIR/src/leju-hardware/config/roban2-0_dual_canbus_cofig.yaml"
ROBAN2_0_SINGLE_SOURCE_CONFIG_FILE="$PROJECT_DIR/src/leju-hardware/config/roban2-0_single_canbus_cofig.yaml"

# Roban2-1
ROBAN2_1_DUAL_SOURCE_CONFIG_FILE="$PROJECT_DIR/src/leju-hardware/config/roban2-1_dual_canbus_cofig.yaml"
ROBAN2_1_SINGLE_SOURCE_CONFIG_FILE="$PROJECT_DIR/src/leju-hardware/config/roban2-1_single_canbus_cofig.yaml"
